...
<div id="package-icons" class="tab-pane">
    ...
    <?php } */ ?>
    <div class="w3eden"><input style="background: url(<?php echo get_post_data($post,'icon', true); ?>) no-repeat;background-size: 32px;padding-left: 40px" id="wpdmiconurl" placeholder="Icon URL" value="<?php echo get_post_data($post,'icon', true); ?>" type="text"  name="file[icon]"  class="form-control" ></div>
    <br clear="all" />
    <?php
    /*
    ...
    */
    ...
    <script type="text/javascript">
        ...
        jQuery('#<?php echo md5(get_post_data($post,'icon', true)) ?>').addClass("iactive");
        <?php } ?>    
