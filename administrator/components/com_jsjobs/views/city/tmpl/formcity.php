        ...
        <form action="index.php" method="POST" name="adminForm" id="adminForm" >
            <div class="js-form-area">
                ...
                <div class="js-form-wrapper">
                    ...
                    <div class="jsjobs-value"><input class="inputbox required" type="text" name="name" id="name" size="40" maxlength="255" value="<?php if (isset($this->city)) echo $this->city->name; ?>" /></div>
                </div>
                <div class="js-form-wrapper">
