...
// for joomla 1.6
    Joomla.submitbutton = function (task) {
        if (task == '') {
            ...
            if (task == 'shift.savejobshiftsave' || task == 'shift.savejobshiftandnew' || task == 'shift.savejobshift') {
...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=shift&view=shift&layout=shifts"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a>
            <?php if (isset($this->application->id)){ ?>
            <span id="heading-text"><?php echo JText::_('Edit Shifts'); ?></span>
            <?php }else{ ?>
            <span id="heading-text"><?php echo JText::_('Form Shifts'); ?></span>
            <?php } ?>
        </div>
...
?>/>  
                ...
                <input type="hidden" name="task" value="shift.savejobshift" />
            ...
            <div class="js-buttons-area">
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=shift&view=shift&layout=shifts"><?php echo JText::_('Cancel'); ?></a>
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('Save Shift'); ?>" />
            </div>
