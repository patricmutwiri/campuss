...
//        layout start
        if ($layoutName == 'formshift') {          // shifts
            ...
            JToolBarHelper::title(JText::_('Shift') . ': <small><small>[ ' . $text . ' ]</small></small>');
            JToolBarHelper::apply('shift.savejobshiftsave', JText::_('Save'));
            ...
            JToolBarHelper::title(JText::_('Shifts'));
            JToolBarHelper::addNew('shift.edijobshift');
            JToolBarHelper::editList('shift.edijobshift');
            JToolBarHelper::deleteList(JText::_('Are You Sure?'), 'shift.remove');
            $form = 'com_jsjobs.shift.list.';
            ...
            $result = $this->getJSModel('shift')->getAllShifts($searchtitle, $searchstatus, $limitstart, $limit);
            $items = $result[0];
            $total = $result[1];
