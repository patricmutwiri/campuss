...
// for joomla 1.6
    Joomla.submitbutton = function (task) {
        if (task == '') {
            ...
            if (task == 'age.savejobagesave' || task == 'age.savejobageandnew' || task == 'age.savejobage') {
...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=age&view=age&layout=ages"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a>
            <?php if (isset($this->application->id)){ ?>
            <span id="heading-text"><?php echo JText::_('Edit Age'); ?></span>
            <?php }else{ ?>
            <span id="heading-text"><?php echo JText::_('Form Age'); ?></span>
            <?php } ?>
        </div>
        <form action="index.php" method="POST" name="adminForm" id="adminForm">
            <div class="js-form-area">
                ...
                <input type="hidden" name="task" value="age.savejobage" />
                <input type="hidden" name="option" value="<?php echo $this->option; ?>" />
            </div>
            <div class="js-buttons-area">
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=age&view=age&layout=ages"><?php echo JText::_('Cancel'); ?></a>
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('Save Age'); ?>" />
            </div>
