...
// for joomla 1.6
    Joomla.submitbutton = function (task) {
        if (task == '') {
            ...
            if (task == 'experience.savejobexperiencesave' || task == 'experience.savejobexperienceandnew' || task == 'experience.savejobexperience') {
...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=experience&view=experience&layout=experience"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a>
        <?php if (isset($this->application->id)){ ?>
        <span id="heading-text"><?php echo JText::_('Edit Experience'); ?></span>
        <?php }else{ ?>
        <span id="heading-text"><?php echo JText::_('Form Experience'); ?></span>
         <?php } ?>
        </div>
...
?>/></span> <label class="js-publish" for="status" ><?php echo JText::_('Publish'); ?></label>
                ...
                <input type="hidden" name="task" value="experience.savejobexperience" />
                <input type="hidden" name="option" value="<?php echo $this->option; ?>" />
            </div>
            <div class="js-buttons-area">
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=experience&view=experience&layout=experience"><?php echo JText::_('Cancel'); ?></a>
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('Save Experience'); ?>" />
            </div>
