...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=jsjobs&view=jsjobs&layout=controlpanel"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Employer Packages'); ?></span></div>
    ...
    <?php if(!empty($this->items)){ ?>
                <table class="adminlist" border="0" id="js-table">
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        $link = JFilterOutput::ampReplace('index.php?option=' . $this->option . '&task=employerpackages.edit&cid[]=' . $row->id);
                        ?>
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="center"><?php if($row->price == 0){ echo JText::_('Free');} else{ if($currency_align == 1) echo $row->symbol.' '.$row->price; else echo $row->price.' '.$row->symbol; }  ?></td>
