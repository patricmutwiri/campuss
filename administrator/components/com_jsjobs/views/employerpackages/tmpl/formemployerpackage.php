...
// for joomla 1.6
    Joomla.submitbutton = function (task) {
        if (task == '') {
            ...
            if (task == 'employerpackages.saveemployerpackage') {
...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=employerpackages"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a>
        <?php if (isset($this->package->id)){ ?>
        <span id="heading-text"><?php echo JText::_('Edit Employer Package'); ?></span>
        <?php }else{ ?>
        <span id="heading-text"><?php echo JText::_('Form Employer Package'); ?></span>
         <?php } ?>
        </div>
        <form action="index.php" method="post" name="adminForm" id="adminForm" >
            ...
            <input type="hidden" name="check" value="post"/>
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="companiesallow"><?php echo JText::_('Companies Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="companiesallow" id="companiesallow" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->companiesallow; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?> </div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="jobsallow"><?php echo JText::_('Job Allow'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="jobsallow" id="jobsallow" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->jobsallow; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="viewresumeindetails"><?php echo JText::_('View Resume In Details'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="viewresumeindetails" id="viewresumeindetails" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->viewresumeindetails; ?>" />&nbsp;<?php echo JText::_('-1 To Unlimited') ?>&nbsp;&nbsp;<?php echo ' ( ' . JText::_('Effect On Applied Resume') . ' ) ' ?></div>
                </div>


                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="resumesearch"><?php echo JText::_('Resume Search'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['resumesearch']; ?></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="saveresumesearch"><?php echo JText::_('Resume Save Search'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['saveresumesearch']; ?></div>
                </div>
                
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjob"><?php echo JText::_('Enforce Un-publish Job'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><div class="div-white"><span class="js-cross"><input type="checkbox" name="enforcestoppublishjob" id="enforcestoppublishjob" value="1" <?php
                                   if (isset($this->package)) {
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjobvalue"><?php echo JText::_('Enforce Unpublish Value'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><input class="inputbox validate-numeric" type="text" name="enforcestoppublishjobvalue" id="enforcestoppublishjobvalue" size="40" maxlength="255" value="<?php if (isset($this->package)) echo $this->package->enforcestoppublishjobvalue; ?>" /></div>
                </div>

                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for="enforcestoppublishjobtype"><?php echo JText::_('Enforce Unpublish Value Type'); ?>:&nbsp;</label>
                    <div class="jsjobs-value"><?php echo $this->lists['unpublishjobtype']; ?></div>
                </div>
                ...
                <div class="js-form-wrapper">
                    <label class="jsjobs-title" for=""></label>
    ...
    <div class="js-form-wrapper">
        ...
        <div class="jsjobs-value">
            <?php if ($paymethodlink->title == "Paypal") { ?>
                <input id="<?php echo $paymethodlink->title; ?>" class="inputbox " type="hidden" name="link[]"  size="50" maxlength="255" value=""/>            <?php } elseif ($paymethodlink->title == "Pagseguro") { ?>
...
?>
                ...
                <input type="hidden" name="id" id="id" value="<?php if (isset($this->package)) echo $this->package->id; ?>" />
                <input type="hidden" name="task" value="employerpackages.saveemployerpackage" />
        ...
        <div class="js-buttons-area">
            <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=employerpackages"><?php echo JText::_('Cancel'); ?></a>
            <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('Save Employer Package'); ?>" />
        </div>
