...
$sort_combo = array(
    ...
    '1' => array('value' => 1, 'text' => JText::_('Country Name')),
    ...
    <div id="jsjobs-content">
      <form action="index.php?option=com_jsjobs" method="post" name="adminForm" id="adminForm">
        <div id="jsjobs-heading">
            ...
            <span id="heading-text"><?php echo JText::_('Countries'); ?></span>
         ...
         <div id="jsjobs_filter_wrapper">
            ...
            <span class="jsjobs-filter"><div class="mycheckboxblock"><input type="checkbox" class="jsinputstate" id="hasstates" name="hasstates" value="" <?php if (isset($this->lists['hasstates'])) echo "checked"; ?> /><label id="hasstates" for="hasstates" name="hasstates" class="jshasstates"><?php echo JText::_('Has States'); ?></label></div></span>
            ...
            <span class="jsjobs-filter"><button class="js-button" onclick="document.getElementById('searchname').value = '';
                    ...
                    document.getElementById('hasstates').checked = false;                                                        
                ...
                <table class="adminlist" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th width="13%" class="center"><?php echo JText::_('States'); ?></th>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td class="center"><a href="index.php?option=com_jsjobs&c=state&view=state&layout=states&ct=<?php echo $row->id; ?>"><?php echo JText::_('States'); ?></a></td>
                            <td class="center"><a href="index.php?option=com_jsjobs&c=city&view=city&layout=cities&ct=<?php echo $row->id; ?>"><?php echo JText::_('Cities'); ?></a></td>
                        </tr>
                        <?php
                        $k = 1 - $k;
                    }
