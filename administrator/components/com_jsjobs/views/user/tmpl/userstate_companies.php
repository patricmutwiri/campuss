...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=paymenthistory&view=paymenthistory&layout=payment_report"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Employer Stats'); ?></span></div>
    ...
    <tr>
        ...
        <?php }else{ JSJOBSlayout::getNoRecordFound(); } ?>
                ...
                <input type="hidden" name="layout" value="userstate_companies" />
                <input type="hidden" name="task" value="" />
                <input type="hidden" name="md" value="<?php if($this->companyuid) echo $this->companyuid; else echo ''; ?>" />
