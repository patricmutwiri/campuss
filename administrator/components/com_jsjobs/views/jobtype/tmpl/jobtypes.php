...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=jsjobs&view=jsjobs&layout=controlpanel"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Job Types'); ?></span></div>
        <form action="index.php" method="post" name="adminForm" id="adminForm">
            ...
            <table class="adminlist" border="0" cellspacing="5" id="js-table">
                <thead>
                    <tr>
                        <th width="20">
                            <?php if (JVERSION < '3') { ?> 
                ...
                for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                    ...
                    $link = JFilterOutput::ampReplace('index.php?option=' . $this->option . '&task=jobtype.editjobtype&cid[]=' . $row->id);
                    ?>
                    <tr valign="top" class="<?php echo "row$k"; ?>">
                        ...
                        <td align="center">
                            ...
                            <?php } else { ?>
                                <a href="index.php?option=com_jsjobs&c=common&task=makedefault&for=jobtypes&id=<?php echo $row->id; ?>">
                        ...
                        <td align="center">
                            ...
                            $status_link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=common.makePublishUnpublish&for=jobtypes&status='.$status_value.'&cid[]='.$row->id);
                            ?>
                        ...
                        <td align="center">
                            <?php if ($i != 0 || $this->pagination->pagesCurrent > 1) { ?>
                                <a href="index.php?option=com_jsjobs&c=common&task=defaultorderingdown&for=jobtypes&id=<?php echo $row->id; ?>">
                            ...
                            <?php if ($i < $n - 1 || $this->pagination->pagesCurrent < $this->pagination->pagesTotal) { ?>
                                <a href="index.php?option=com_jsjobs&c=common&task=defaultorderingup&for=jobtypes&id=<?php echo $row->id; ?>">
...
<?php }else{ JSJOBSlayout::getNoRecordFound(); } ?>        
            ...
            <input type="hidden" name="c" value="jobtype" />
            <input type="hidden" name="view" value="jobtype" />
            <input type="hidden" name="layout" value="jobtypes" />
