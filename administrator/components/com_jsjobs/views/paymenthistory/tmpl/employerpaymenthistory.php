...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=jsjobs&view=jsjobs&layout=controlpanel"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a><span id="heading-text"><?php echo JText::_('Employer Payment History'); ?></span></div>
                ...
                <table class="adminlist" border="0" id="js-table">
                    <thead>
                        <tr>
                            ...
                            <th class="title"><?php echo JText::_('Employer Name'); ?></th>
                    ...
                    for ($i = 0, $n = count($this->items); $i < $n; $i++) {
                        ...
                        <tr valign="top" class="<?php echo "row$k"; ?>">
                            ...
                            <td align="left"><?php echo $row->employername; ?></td>
