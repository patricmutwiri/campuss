...
<div id="jsjobs-wrapper">
    ...
    <div id="jsjobs-content">
        <div id="jsjobs-heading"><a id="backimage" href="index.php?option=com_jsjobs&c=highesteducation&view=highesteducation&layout=highesteducations"><img src="components/com_jsjobs/include/images/back-icon.png" alt="<?php echo JText::_('Back');?>" ></a>
            <?php if (isset($this->application->id)){ ?>
            <span id="heading-text"><?php echo JText::_('Edit Highest Education'); ?></span>
            <?php }else{ ?>
            <span id="heading-text"><?php echo JText::_('Form Highest Education'); ?></span>
            <?php } ?>
        </div>
...
?>/>                                        </span> <label class="js-publish" for="status" ><?php echo JText::_('Publish'); ?></label>
            ...
            <div class="js-buttons-area">
                <a class="js-btn-cancel" href="index.php?option=com_jsjobs&c=highesteducation&view=highesteducation&layout=highesteducations"><?php echo JText::_('Cancel'); ?></a>
                <input type="submit" class="js-btn-save" name="submit_app" onclick="return validate_form(document.adminForm)" value="<?php echo JText::_('Save Highest Education'); ?>" />
            </div>
