...
<div id="js_jobs_main_wrapper">
    ...
    if ($this->mypurchasehistory_allowed == VALIDATE) { // employer 
        if (!empty($this->packages)) {
                        ...
                        <div class="jsjobs-purchasehistory-main">
                            <span class="jsjobs-title-wrap">
                                <span class="jsjobs-title-wrap-purchase">
                                    <a class="anchor" href="index.php?option=com_jsjobs&c=employerpackages&view=employerpackages&layout=package_buynow&jslayfor=detail&gd=<?php echo $package->id; ?>&Itemid=<?php echo $this->Itemid; ?>"><?php echo JText::_($package->title); ?></a>
                                </span>
                                <span class="jsjobs-data-price-wrap">
                                    ...
                                    <span class="jsjobs-price-wrap">
                                        <span class="stats_data_value">
                                            <?php 
                                            if ($package->paidamount != 0) echo $package->symbol . $package->paidamount;
                                            else echo JText::_('Free');
                                            ?>
                                        </span>
                                    </span>
                                </span>
                                ...
                                <div class="jsjobs-listing-datawrap-details">
                                    <div class="jsjobs-listing-wrap">
                                        <div class="jsjobs-values-wrap">
                                            ...
                                            <span class="stats_data_value">
                                                <?php 
                                                if ($package->companiesallow == -1) echo JText::_('Unlimited');
                                                else echo $package->companiesallow;
                                                ?>
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="jsjobs-listing-wrap">
                                        <div class="jsjobs-values-wrap bordernone">
                                            ...
                                            <span class="stats_data_value">
                                                <?php 
                                                if ($package->transactionverified == 1) $imgscr  = JURI::root().'components/com_jsjobs/images/publish-icon.png' ;
            ...
            ?>  
            <form action="<?php echo JRoute::_('index.php?option=com_jsjobs&c=purchasehistory&view=purchasehistory&layout=employerpurchasehistory&Itemid=' . $this->Itemid ,false); ?>" method="post">
...
<script type="text/javascript">
    ...
    jQuery("div.jsjobs-values-wrap").last().css("border-bottom","none");
});
    function draw() {  
